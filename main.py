...
if __name__ == "__main__":
    ...
    if args.mode == "train":
        detect.train(n_epochs=args.n_epochs, batch_sizes=args.batch_sizes, data_dir=args.data_dir, log_dir=args.log_dir,
                     fractions=args.fractions, workers=args.workers, use_gpu=args.use_gpu, standardize=True)

    elif args.mode == "test":
        detect.test(batch_size=args.batch_sizes, data_dir=args.data_dir, fraction=args.fractions,
